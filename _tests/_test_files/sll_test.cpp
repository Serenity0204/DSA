...
bool basic_test(bool debug = false)
{
    ...
    DSA::SLL<int>::Iterator it_2 = list.search(4);
    if (it == it_2)
    {
    ...
    for (int i = 0; i < list2.size(); i++)
    {
        if (list[i] != list2[i])
        {
            cout << "assign operator is wrong" << endl
                 << endl;
            break;
        }
    }
    cout << "assign operator is ok" << endl
         << endl;
