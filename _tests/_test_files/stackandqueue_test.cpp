...
bool test_queue(bool debug = false)
{
    ...
    for (DSA::Queue<int>::Iterator it = q.begin(); it != q.end(); it++)
    {
        cout << "it->>" << *it << endl;
    }
    cout << endl
    ...
    DSA::Queue<int>::Iterator it = q.begin();
...
bool test_stack(bool debug = false)
{
    ...
    for (DSA::Stack<int>::Iterator it = s.begin(); it != s.end(); it++)
    {
        cout << "it->>" << *it << endl;
    }
    cout << endl
    ...
    DSA::Stack<int>::Iterator it = s.begin();
    cout << "Iterator is_null(): " << boolalpha << it.is_null() << endl;
